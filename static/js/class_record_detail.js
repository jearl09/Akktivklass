// class_record_detail.js
// This file should be pure JavaScript. Any Django variables should be passed in via the template using window.* variables.

// Example: In your template, set these before including this script:
// <script>
//   window.uploadedStudents = ...;
//   window.selectedSubjectCode = ...;
//   window.csrfToken = ...;
//   window.saveUrl = ...;
//   window.clearSessionUrl = ...;
//   window.enrolledCount = ...;
//   window.unenrolledCount = ...;
//   window.studentsData = ...;
// </script>
// <script src="{% static 'js/class_record_detail.js' %}"></script>
...
// window.selectedSubjectCode should be set in the template
// window.uploadedStudents should be set in the template
// window.csrfToken should be set in the template
// window.saveUrl should be set in the template
// window.clearSessionUrl should be set in the template
// window.enrolledCount, window.unenrolledCount should be set in the template
// window.studentsData should be set in the template
        ...
        div.addEventListener("click", () => {
          ...
          fetch("/class_record/enroll-student/", {
            ...
            body: JSON.stringify({
              ...
              subject_code: window.selectedSubjectCode,
            }),
          })
            .then((response) => {
              if (!response.ok) {
...
const enrolledCount = window.enrolledCount || 0;
const unenrolledCount = window.unenrolledCount || 0;
